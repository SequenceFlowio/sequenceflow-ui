...
export const nl: Dictionary = {
  ...
  settings: {
    ...
    smtpDesc: "Forwarding ontvangt klantmails. SMTP verstuurt replies vanuit je echte supportadres, zodat klanten jouw merk zien in plaats van een ReplyOS-afzenderdomein.",
