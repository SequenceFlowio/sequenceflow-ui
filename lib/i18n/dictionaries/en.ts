export const en = {
  ...
  settings: {
    ...
    senderTitle: "Reply sender",
    senderDesc: "This is the name and email address your customers see when a reply is sent.",
    senderNameLabel: "Sender name",
    senderNamePlaceholder: "e.g. Customer Support",
    senderEmailLabel: "Sender email",
    senderHelp: "Keep the default sender or switch to your own domain later after verifying it in Resend.",
