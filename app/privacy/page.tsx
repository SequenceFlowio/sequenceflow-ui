    ...
    <div style={{
      ...
      <div style={{ maxWidth: 760, margin: "0 auto", padding: "60px 40px 80px" }}>
        ...
        <Section title="5. Data retention">
          <ul style={ulStyle}>
            <li style={liStyle}><strong>Email content / tickets:</strong> Open, review, and scheduled drafts are retained while they need action. SequenceFlow&apos;s imported copy of handled and archived tickets and customer-sent attachments is automatically deleted after 90 days. Locally marked spam is deleted after 30 days. You can keep a ticket longer or permanently delete it earlier from Archive or Spam. The original provider email remains untouched.</li>
