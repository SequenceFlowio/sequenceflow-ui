...
export const metadata: Metadata = {
  title: `Privacy Policy | ${FULL_PRODUCT_NAME}`,
  description: `Privacy policy for ${FULL_PRODUCT_NAME} — how we collect, use and protect your data.`,
};
    ...
    <div style={{
      ...
      <div style={{ maxWidth: 760, margin: "0 auto", padding: "60px 40px 80px" }}>
        ...
        <Section title="1. Who we are">
          <P>{COMPANY_NAME} (&quot;we&quot;, &quot;us&quot;, &quot;our&quot;) operates {FULL_PRODUCT_NAME} at <strong>support.sequenceflow.io</strong> — an AI-powered customer support workspace that reads incoming customer emails, uses connected commerce context, generates AI draft replies, and lets your team approve and send them.</P>
        ...
        <Section title="2. Data we collect">
          ...
          <P>To provide the core service, incoming customer emails are imported into Support through your configured inbound setup, such as forwarding or IMAP mailbox access.</P>
          <P><strong>Your source mailbox remains untouched:</strong> Support reads and stores a service copy of incoming messages. It does not delete, move, archive, or otherwise remove the original customer email from Gmail, Hostinger, or another connected email provider.</P>
          ...
          <P><strong>What we do NOT do:</strong> We do not sell, rent, transfer, or share your email data with any third party for advertising, analytics, or any purpose beyond providing the Support service.</P>
        ...
        <Section title="3. How we use your data">
          <ul style={ulStyle}>
            <li style={liStyle}>To receive incoming customer emails forwarded to your unique Support address and generate AI draft replies</li>
            <li style={liStyle}>To create and send email replies on your behalf when you approve them</li>
            <li style={liStyle}>To display email threads, drafts, and analytics in the Support dashboard</li>
        ...
        <Section title="4. Data protection mechanisms">
          ...
          <ul style={ulStyle}>
            ...
            <li style={liStyle}><strong>Minimal Google access:</strong> Google OAuth is used for account authentication. Support does not request Google Drive, Calendar, or Gmail mailbox access through Google OAuth.</li>
            <li style={liStyle}><strong>Limited retention:</strong> Email content and customer-sent attachments are stored only to enable the reply workflow. Support&apos;s stored copy of handled and archived tickets is automatically removed after 90 days. This never removes the original message from your email provider.</li>
        ...
        <Section title="5. Data retention">
          <ul style={ulStyle}>
            <li style={liStyle}><strong>Email content / tickets:</strong> Open, review, and scheduled drafts are retained while they need action. Support&apos;s imported copy of handled and archived tickets and customer-sent attachments is automatically deleted after 90 days. Locally marked spam is deleted after 30 days. You can keep a ticket longer or permanently delete it earlier from Archive or Spam. The original provider email remains untouched.</li>
            <li style={liStyle}><strong>Spam and AI usage metadata:</strong> Pseudonymous spam feedback, model usage, waivers, and refund events are retained for up to 24 months to improve filtering, prevent billing abuse, and keep usage calculations auditable. These records do not retain the full email body.</li>
            <li style={liStyle}><strong>Pseudonymous case memory:</strong> Before a handled ticket expires, Support may preserve a quote-free structured summary linked to a tenant-specific customer key. Case memories, decision and outcome metadata, and sanitised commerce audit events are retained for no more than 24 months.</li>
        ...
        <Section title="7. Google sign-in">
          <P>Google OAuth is used to authenticate your account. We receive the basic profile information described in section 2.1 and use it only to create, secure, and display your Support account. We do not use Google account data for advertising or credit decisions.</P>
        </Section>
