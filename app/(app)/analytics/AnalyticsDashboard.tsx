...
function AnalyticsStyles() {
  return <style>{`
    ...
    .analytics-metrics{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));margin-bottom:16px;border:1px solid var(--sf-border);border-radius:8px;background:var(--sf-surface);overflow:hidden}.analytics-metric{display:grid;grid-template-columns:34px minmax(0,1fr);align-items:center;gap:10px;padding:15px}.analytics-metric+.analytics-metric{border-left:1px solid var(--sf-border)}.analytics-metric-icon{width:34px;height:34px;display:grid;place-items:center;border-radius:7px;background:var(--sf-surface-2);color:var(--sf-text-muted)}.analytics-metric span,.analytics-metric strong,.analytics-metric small{display:block}.analytics-metric span{color:var(--sf-text-muted);font-size:10px;font-weight:800;text-transform:uppercase}.analytics-metric strong{margin-top:3px;font-size:23px;line-height:1}.analytics-metric small{margin-top:5px;color:var(--sf-text-subtle);font-size:10px;line-height:1.35}
