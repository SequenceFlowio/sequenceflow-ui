...
export default function EscalationSettings() {
  ...
  return <div className="settings-stack">
    ...
    <Section icon={<MailPlus size={18} />} title={t.settings.escalationTitle} description={t.settings.escalationDesc} action={<div className="settings-actions">{canManage && !showForm ? <button className="settings-btn" onClick={() => { setShowForm(true); setFormError(null); }}><Plus size={14} />{t.settings.deptAddTitle}</button> : null}</div>}>
