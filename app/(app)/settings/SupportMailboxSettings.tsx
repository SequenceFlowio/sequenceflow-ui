...
function MailboxStyles() {
  return <style>{`
    ...
    .mailbox-preservation{padding:11px 20px;display:flex;align-items:flex-start;gap:10px;border-bottom:1px solid rgba(199,245,111,.3);background:rgba(199,245,111,.1);color:#668c22}.mailbox-preservation>svg{flex:none;margin-top:1px}.mailbox-preservation strong,.mailbox-preservation span{display:block}.mailbox-preservation strong{font-size:11px;color:#456614}.mailbox-preservation span{margin-top:2px;font-size:11px;line-height:1.5;color:#617345}
