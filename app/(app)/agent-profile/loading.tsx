export default function AgentProfileLoading() {
  return (
    <main style={{ width: "min(100%, 1080px)", margin: "0 auto", padding: "40px 24px 72px" }}>
      ...
      <div style={{ display: "grid", gap: 18, marginTop: 24 }}>
        {[142, 104, 220].map((height) => (
          <div key={height} style={{ height, border: "1px solid var(--sf-border)", borderRadius: 20, background: "var(--sf-surface)" }} />
        ))}
      </div>
    </main>
  );
