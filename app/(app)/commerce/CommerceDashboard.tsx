  ...
  return (
    <main className="commerce-page">
      <style>{`
        ...
        .commerce-feedback{display:flex;align-items:flex-start;gap:10px;padding:12px 14px;border:1px solid #f0caca;border-radius:8px;background:#fff5f5;color:var(--tone-danger);font-size:11px;line-height:1.5}.commerce-feedback.success{border-color:rgba(199,245,111,.3);background:rgba(199,245,111,.1);color:var(--tone-success)}.commerce-feedback.info{border-color:#cbdcf8;background:#f5f8ff;color:#315b9a}.commerce-feedback strong{display:block;color:inherit}.commerce-feedback p{margin:2px 0 0}
