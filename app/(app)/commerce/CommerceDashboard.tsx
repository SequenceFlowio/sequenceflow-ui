  ...
  return (
    <main className="commerce-page">
      <style>{`
        ...
        .commerce-head{display:flex;align-items:flex-end;justify-content:space-between;gap:18px}.commerce-head h1{margin:0;font-size:30px;font-weight:500;line-height:1.15;letter-spacing:-.02em}.commerce-head p{max-width:720px;margin:7px 0 0;color:var(--muted);font-size:14px;line-height:1.6}
        ...
        .commerce-feedback{display:flex;align-items:flex-start;gap:10px;padding:12px 14px;border:1px solid rgba(248,113,113,.3);border-radius:8px;background:rgba(248,113,113,.08);color:var(--tone-danger);font-size:11px;line-height:1.5}.commerce-feedback.success{border-color:rgba(199,245,111,.3);background:rgba(199,245,111,.1);color:var(--tone-success)}.commerce-feedback.info{border-color:rgba(199,245,111,.3);background:rgba(199,245,111,.08);color:var(--tone-success)}.commerce-feedback strong{display:block;color:inherit}.commerce-feedback p{margin:2px 0 0}
        .commerce-section-head{display:flex;align-items:center;justify-content:space-between;gap:15px;padding:14px 17px;border-bottom:1px solid var(--border)}.commerce-section-title{display:flex;align-items:center;gap:11px}.commerce-section-title h2{margin:0;font-size:14px;letter-spacing:0}.commerce-section-title p{margin:3px 0 0;color:var(--muted);font-size:11px}.commerce-scope{display:inline-flex;align-items:center;gap:5px;padding:5px 8px;border-radius:999px;background:rgba(199,245,111,.1);color:var(--tone-success);font-size:9px;font-weight:800}
        .commerce-scope-help{position:relative}.commerce-scope-help summary{list-style:none;cursor:pointer}.commerce-scope-help summary::-webkit-details-marker{display:none}.commerce-scope-help[open] .commerce-scope{background:rgba(199,245,111,.15)}.commerce-scope-copy{position:absolute;z-index:4;top:calc(100% + 7px);right:0;width:min(320px,calc(100vw - 40px));padding:11px 12px;border:1px solid rgba(199,245,111,.3);border-radius:8px;background:var(--surface);box-shadow:0 12px 28px rgba(31,55,92,.14);color:var(--text);font-size:10px;line-height:1.55}
