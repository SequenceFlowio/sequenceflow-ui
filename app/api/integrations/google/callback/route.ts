...
const REDIRECT_URI = (process.env.NEXT_PUBLIC_SITE_URL ?? "https://emailreply.sequenceflow.io") + "/api/integrations/google/callback";
const BASE         = process.env.NEXT_PUBLIC_SITE_URL ?? "https://emailreply.sequenceflow.io";
