  ...
  return (
    ...
    >
      <style>{`
        ...
        .plan-radio:hover { border-color: rgba(180,240,0,0.5) !important; }
      `}</style>
              ...
              return (
                ...
                >
                  ...
                  <div style={{
                    ...
                    {isSelected && (
                      <div style={{ width: "6px", height: "6px", borderRadius: "50%", background: "#0B1220" }} />
                    )}
                  </div>
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    ...
                    <p style={{ fontSize: "13px", color: "rgba(255,255,255,0.45)", margin: "0 0 8px", lineHeight: 1.4 }}>
                      {plan.features[0]} · {plan.features[1]}
                    </p>
                    {isSelected && (
                      <ul style={{ margin: 0, padding: 0, listStyle: "none", display: "flex", flexWrap: "wrap", gap: "4px 14px" }}>
                        {plan.features.map(f => (
                          <li key={f} style={{ fontSize: "12px", color: "rgba(255,255,255,0.55)", display: "flex", alignItems: "center", gap: "5px" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
            <button
              ...
              style={{
                ...
                borderRadius: "10px",
                border:       "none",
                background:   loading ? "#86b800" : "#B4F000",
                color:        "#0B1220",
                fontSize:     "14px",
                fontWeight:   700,
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "14px" }}>
              {FEATURE_ICONS.map(({ icon, label }) => (
                <div key={label} style={{ display: "flex", alignItems: "center", gap: "12px" }}>
                  ...
                  <span style={{ fontSize: "13px", fontWeight: 500, color: "#0B1220", lineHeight: 1.3 }}>
                    {label}
                  </span>
                </div>
              ))}
