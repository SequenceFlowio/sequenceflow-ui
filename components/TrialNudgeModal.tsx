...
const PHASE_CONTENT: Record<Phase, PhaseContent> = {
  discovery: {
    ...
    subtitle:          (d) => `Je hebt ${d ?? 14} dagen lang volledige toegang tot Support. Ontdek hoe AI je emails automatisch beantwoordt — stel je kennisbank in en verwerk je eerste mails.`,
  ...
  consideration: {
    ...
    title:             () => "Hoe bevalt Support tot nu toe?",
